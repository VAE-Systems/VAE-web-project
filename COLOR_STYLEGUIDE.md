...
/* Active States */ --color-interactive-active: /* Dunkler als hover */ /* Focus States */
...
```css
/* Links */
--color-link: /* Blau-Töne für alle Modi */ --color-link-hover: /* Dunkler/heller je nach Modus */ /* Code */
  --color-code: /* Dunkel für Light, hell für Dark */ --color-code-bg: /* Subtile Hintergründe */;
```
