        ...
        <div className="flex flex-col gap-4 py-4 lg:h-20 lg:flex-row lg:items-center lg:gap-8">
          ...
          <div className="flex w-full flex-col gap-4 lg:flex-1 lg:flex-row lg:items-center lg:gap-6">
            ...
            <div className="flex items-center gap-3 lg:hidden">
              <a
                href={CTA_URL}
                className="flex flex-1 items-center justify-center gap-2 rounded-xl border border-vae-turquoise/40 px-4 py-3 text-sm font-semibold text-white transition-all duration-200 hover:border-vae-turquoise hover:bg-vae-turquoise/10"
              >
