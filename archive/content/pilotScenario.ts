...
export const pilotScenario: PilotScenario = {
  ...
  intro:
    'So sieht ein neutraler, häufig sinnvoller Start aus – ohne künstliche Komplexität und mit schnellem Lernertrag.',
  context:
    'Ausgangslage: Interne Wissensfragmente (Confluence / Files / E-Mail), wiederkehrende manuelle Antwort-/Rechercheaufwände, erste Ideen “Wir brauchen einen Chatbot?”.',
  goals: [
