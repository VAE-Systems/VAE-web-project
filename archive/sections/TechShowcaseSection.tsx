...
/**
 * Archived: TechShowcaseSection
 *
 * Reasons:
 * - Removed from HomePage because auto-scrolling carousel distracted from core funnel.
 * - Kept here for quick reactivation. To re-enable, import into HomePage and render where desired.
 *
 * Notes:
 * - Uses duplicated tool list for seamless marquee loop.
 * - Honors prefers-reduced-motion (auto-scroll disabled when set).
 * - Hover/focus pauses motion; tooltip-like duplicate description is shown below each tile.
 */
