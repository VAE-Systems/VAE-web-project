        ...
        <div className="container-vae max-w-5xl">
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-20">
            {placeholderTools.map(t => (
              <div key={t.name} className="p-6 rounded-2xl bg-white/5 border border-white/10 hover:border-vae-turquoise/40 transition-all">
                <h3 className="font-semibold text-white mb-2 text-sm">{t.name}</h3>
