...
const ProductsPage: React.FC = () => {
  return (
    <div className="min-h-[100dvh]">
      ...
      <section className="py-24 border-b border-border-primary/5 dark:border-white/5 bg-gradient-to-b from-bg-primary dark:from-bg-dark to-bg-primary/70 dark:to-bg-darker/70">
        <div className="container-vae max-w-5xl space-y-20">
          <div className="space-y-6">
            <h2 className="text-2xl md:text-3xl font-semibold text-text-light dark:text-white">Typische Startpunkte</h2>
            <div className="grid md:grid-cols-3 gap-8">
              {[{
                ...
                <div key={c.t} className="p-6 rounded-2xl bg-bg-primary/5 dark:bg-white/5 border border-border-primary dark:border-white/10">
                  <h3 className="text-sm font-semibold text-text-light dark:text-white mb-2">{c.t}</h3>
          ...
          <div className="space-y-6">
            <h2 className="text-2xl md:text-3xl font-semibold text-text-light dark:text-white">Warum eine modulare Suite?</h2>
          ...
          <div className="space-y-6">
            <h2 className="text-2xl md:text-3xl font-semibold text-text-light dark:text-white">Leitprinzipien</h2>
            <div className="grid md:grid-cols-2 gap-10">
              <div className="space-y-4 text-sm text-text-secondary leading-relaxed">
                <p><span className="text-text-light dark:text-white font-medium">Transparenz:</span> Schnittstellen & Konfiguration nachvollziehbar; keine verdeckten Abhängigkeiten in proprietären Diensten.</p>
                <p><span className="text-text-light dark:text-white font-medium">Schrittweise Einführung:</span> Jede Ebene (Lösung, Modul, Plattform) kann isoliert Mehrwert liefern und später vertieft werden.</p>
                <p><span className="text-text-light dark:text-white font-medium">Souveränität:</span> On‑Prem & Sovereign Cloud fähig; austauschbare Speicher- & Index‑Adapter.</p>
              </div>
              <div className="space-y-4 text-sm text-text-secondary leading-relaxed">
                <p><span className="text-text-light dark:text-white font-medium">Betriebsfähigkeit:</span> Observability, Metriken & Audit-Pfade als First-Class – nicht nachträglich ergänzt.</p>
                <p><span className="text-text-light dark:text-white font-medium">Ethische Robustheit:</span> Governance‑Artefakte (Zugriff, Versionierung, Evaluierung) klar dokumentierbar.</p>
                <p><span className="text-text-light dark:text-white font-medium">Design für Migration:</span> Entscheidungen minimieren Lock‑in & ermöglichen Austausch einzelner Komponenten.</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <React.Suspense fallback={<div className="py-24 text-center text-text-muted text-sm">Lade FAQ…</div>}>
        <FAQSection
        id="products-faq"
        className="bg-gradient-to-b from-bg-darker via-bg-dark to-bg-darker/90 border-t border-border-primary dark:border-white/5"
