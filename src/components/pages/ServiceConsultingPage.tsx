          ...
          <div className="grid md:grid-cols-5 gap-6 mb-20">
            {[
              ...
              <div key={v.h} className="rounded-2xl p-5 bg-bg-primary/5 dark:bg-white/5 border border-border-primary dark:border-white/10">
                ...
                <p className="text-sm text-text-secondary leading-relaxed">{v.p}</p>
              </div>
            ))}
          </div>
          ...
          <div className="mb-24">
            ...
            <div className="grid md:grid-cols-2 gap-10">
              ...
              <div className="bg-bg-primary/5 dark:bg-white/5 border border-border-primary dark:border-white/10 rounded-2xl p-6">
                ...
                <p className="text-sm text-text-secondary leading-relaxed mb-3">Beratung liefert belastbare Entscheidungsgrundlagen. Umsetzung & produktive Integrationen erfolgen anschließend in <Link to="/services/custom-solutions" className="underline text-vae-turquoise hover:text-text-light dark:hover:text-white">Custom Solutions</Link>; Kompetenzaufbau parallel über <Link to="/services/trainings" className="underline text-vae-turquoise hover:text-text-light dark:hover:text-white">Schulungen & Workshops</Link>.</p>
                <p className="text-sm text-text-secondary leading-relaxed">Offene Standards & vollständige Dokumentation ermöglichen späteren Eigenbetrieb – <span className="text-text-light dark:text-white">kein Lock‑in</span>.</p>
              </div>
            </div>
          </div>
      ...
      <div className="relative flex md:grid md:grid-cols-4 gap-5 md:gap-6 overflow-x-auto md:overflow-visible snap-x snap-mandatory px-1 -mx-1 pb-4 md:pb-2 scrollbar-thin scrollbar-track-transparent scrollbar-thumb-white/10">
        {consultingSteps.map((s,i) => (
          ...
          >
            ...
            <div className="mt-4 pt-3 border-t border-border-primary dark:border-white/10 text-xs text-text-muted relative z-10">
