...
const ValuesPage: React.FC = () => {
  ...
  return (
    <div className="relative z-0 bg-bg-darker text-text-light">
      ...
      <section className="accent-section bg-bg-primary relative overflow-hidden border-b border-text-light/10 dark:border-white/5 dark:bg-gradient-to-b dark:from-bg-darker dark:to-bg-dark">
        <div
        ...
        <div className="container-vae relative flex min-h-[40vh] flex-col items-center justify-center gap-6 py-24 text-center">
          <span className="inline-flex items-center gap-2 rounded-full border border-vae-turquoise/25 bg-white px-4 py-1 text-xs font-semibold uppercase tracking-[0.4em] text-vae-turquoise dark:border-vae-turquoise/40 dark:bg-vae-turquoise/10 dark:text-vae-turquoise">
            Unsere Werte
          </span>
          <h1 className="max-w-4xl text-4xl font-semibold leading-tight text-text-light dark:text-text-light md:text-5xl">
            {HERO_COPY.title}
          </h1>
          <p className="max-w-3xl text-lg leading-relaxed text-text-secondary dark:text-text-secondary">
            {HERO_COPY.subheading}
          </p>
          <p className="mx-auto max-w-3xl text-base leading-relaxed text-text-secondary dark:text-text-secondary/80">
            {HERO_COPY.body}
          </p>
          <p className="inline-flex items-center gap-2 rounded-full border border-text-light/10 bg-white px-4 py-2 text-sm text-text-light dark:border-white/10 dark:bg-white/5 dark:text-white/80">
