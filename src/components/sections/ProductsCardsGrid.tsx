      ...
      <div className="container-vae">
        ...
        <div className="grid md:grid-cols-3 sm:grid-cols-2 gap-6 sm:gap-8" data-animate>
          {items.map(cat => (
            <article
              key={cat.key}
              className="group relative rounded-2xl border border-white/10 bg-white/[0.025] backdrop-blur-md p-5 sm:p-6 flex flex-col overflow-hidden transition-all duration-300 hover:border-vae-turquoise/40 hover:shadow-[0_0_0_1px_rgba(0,255,165,0.12),0_10px_40px_-10px_rgba(0,255,165,0.28)]"
            >
