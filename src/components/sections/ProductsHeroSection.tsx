...
const ProductsHeroSection: React.FC = () => {
  ...
  return (
    ...
    <section className="relative -mt-20 flex items-center min-h-[calc(100vh-5rem)] pt-32 pb-16 sm:pt-40 sm:pb-20 md:pt-52 md:pb-24 overflow-hidden border-b border-white/5 bg-gradient-to-br from-bg-darker via-bg-dark to-bg-darker">
      {/* Animated backdrop */}
      ...
      <div ref={containerRef} className="relative container-vae">
        <div className="flex flex-col items-center text-center gap-6 sm:gap-8">
          <div className="relative flex items-center justify-center">
            <div className="relative w-40 h-40 sm:w-48 sm:h-48 md:w-56 md:h-56 rounded-[3rem] flex flex-col items-center justify-center gap-3 shadow-[0_0_40px_-10px_rgba(var(--vae-turquoise-rgb),0.45)] border border-white/10 bg-[linear-gradient(140deg,rgba(var(--vae-turquoise-rgb),0.18),rgba(var(--vae-turquoise-rgb),0.08)_40%,rgba(0,40,30,0.35))] backdrop-blur-xl">
              <img
                src="/App_Logo_light.svg"
                alt="VAE Systems App Icon"
                className="relative w-40 h-40 sm:w-48 sm:h-48 md:w-56 md:h-56 rounded-[3rem] flex flex-col items-center justify-center gap-3 shadow-[0_0_40px_-10px_rgba(var(--vae-turquoise-rgb),0.45)] border border-white/10 bg-[linear-gradient(140deg,rgba(var(--vae-turquoise-rgb),0.18),rgba(var(--vae-turquoise-rgb),0.08)_40%,rgba(0,40,30,0.35))] backdrop-blur-xl"
              />
