          ...
          {founders.map(f => (
            <div key={f.key} className="relative group rounded-2xl border border-white/10 bg-white/[0.035] backdrop-blur-sm p-6 flex flex-col">
              ...
              <div className="mb-4 relative z-10">
                ...
                <p className="text-vae-turquoise/80 text-[11px] font-medium uppercase tracking-wide mt-1">{f.role}</p>
              </div>
              <p className="text-white/80 text-sm leading-relaxed mb-4 relative z-10">{f.highlight}</p>
