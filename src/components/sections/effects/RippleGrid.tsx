...
const RippleGrid: React.FC<RippleGridProps> = ({
    ...
    useEffect(() => {
        // Respect prefers-reduced-motion: disable mouse interaction & lower intensity
...
void main() {
    ...
    return <div ref={containerRef} className={`w-full h-full relative overflow-hidden [&_canvas]:block ${className}`} />;
};
