      ...
      <div className="container-vae max-w-5xl">
        ...
        <div className="grid gap-6 sm:grid-cols-2 md:grid-cols-3">
          {list.map(t => (
            <div
              key={t.term}
              className="border-border-primary bg-bg-primary/5 group relative rounded-2xl border p-5 transition-colors hover:border-vae-turquoise/40 dark:border-white/10 dark:bg-white/5"
            >
