    ...
    <div className="group relative flex h-full flex-col overflow-hidden rounded-none border border-text-light/10 bg-bg-darker p-8 backdrop-blur-sm transition-all duration-500 hover:border-vae-turquoise/40 hover:shadow-[0_10px_22px_rgba(18,24,20,0.08)] dark:border dark:border-white/10 dark:bg-white/5 dark:hover:border-vae-turquoise/40 dark:hover:shadow-[0_0_0_1px_rgba(var(--vae-turquoise-rgb),0.25),0_12px_44px_-10px_rgba(var(--vae-turquoise-rgb),0.4)]">
      ...
      <div className="relative z-10 mb-6 flex items-start justify-between">
        <div className="flex items-center gap-3">
          <div className="flex h-12 w-12 items-center justify-center rounded-md bg-vae-turquoise/20 text-vae-turquoise">
      ...
      <div className="pointer-events-none absolute inset-0 hidden rounded-none bg-[radial-gradient(circle_at_30%_22%,rgba(var(--vae-turquoise-rgb),0.10),transparent_70%)] opacity-0 transition-opacity duration-500 group-hover:opacity-100 dark:block" />
    </div>
  )
})
