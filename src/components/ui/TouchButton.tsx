...
const TouchButton: React.FC<TouchButtonProps> = ({
  ...
  const baseClasses =
    'inline-flex items-center justify-center font-medium transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-bg-darker active:scale-95'
  ...
  const variantClasses = {
    ...
    outline:
      'border-2 border-vae-turquoise text-vae-turquoise hover:bg-vae-turquoise hover:text-bg-darker focus:ring-vae-turquoise',
