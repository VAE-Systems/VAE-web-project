  ...
  return (
    <div className="max-w-4xl mx-auto p-8 space-y-12">
      ...
      <section className="space-y-6">
        ...
        <div className="space-y-4">
          <div>
            <Text lineHeight="tight" className="bg-gray-100 p-4 rounded">
              Tight Line Height (1.25)<br />
              Dies ist ein Beispieltext mit enger Zeilenhöhe.<br />
              Gut für kompakte Absätze.
            </Text>
          </div>
          <div>
            <Text lineHeight="normal" className="bg-gray-100 p-4 rounded">
              Normal Line Height (1.5)<br />
              Dies ist ein Beispieltext mit normaler Zeilenhöhe.<br />
              Die Standardeinstellung für gute Lesbarkeit.
            </Text>
          </div>
          <div>
            <Text lineHeight="loose" className="bg-gray-100 p-4 rounded">
              Loose Line Height (1.75)<br />
              Dies ist ein Beispieltext mit loser Zeilenhöhe.<br />
      ...
      <section className="space-y-6">
        ...
        <Body>
          Die neuen Typografie-Komponenten lassen sich nahtlos in bestehende Komponenten integrieren:
        </Body>
        ...
        <div className="space-y-4">
          ...
          <div className="bg-gray-50 p-6 rounded-lg">
            ...
            <Body className="mb-4">
              Verwenden Sie semantische Komponenten für bessere SEO und Accessibility:
            </Body>
            <ul className="space-y-2">
              <li><Text size="sm">• Heading1-6 für Überschriften</Text></li>
              <li><Text size="sm">• Body für Fließtext</Text></li>
              <li><Text size="sm">• Caption für Bildunterschriften</Text></li>
              <li><Text size="sm">• Label für Formularelemente</Text></li>
            </ul>
          </div>
        </div>
      </section>
      ...
      <section className="space-y-6">
        ...
        <Body>
          Alle Schriftgrößen skalieren automatisch basierend auf der Bildschirmgröße:
        </Body>

        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="bg-blue-50 p-6 rounded-lg">
            <Text size="lg" weight="semibold" className="text-blue-800 mb-2">
              Mobile First
            </Text>
          ...
          <div className="bg-green-50 p-6 rounded-lg">
            <Text size="lg" weight="semibold" className="text-green-800 mb-2">
              Desktop Scale
            </Text>
      ...
      <section className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="bg-purple-50 p-6 rounded-lg">
            <Text size="lg" weight="semibold" className="text-purple-800 mb-2">
              ⚡ Performance
            </Text>
          ...
          <div className="bg-orange-50 p-6 rounded-lg">
            <Text size="lg" weight="semibold" className="text-orange-800 mb-2">
              ♿ Accessibility
            </Text>
