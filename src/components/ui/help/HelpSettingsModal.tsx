...
export const HelpSettingsModal: React.FC<HelpSettingsModalProps> = ({ isOpen, onClose }) => {
  ...
  return (
    <div
      className="animate-in fade-in fixed inset-0 z-50 flex items-center justify-center bg-black/40 backdrop-blur-sm duration-200"
      onClick={onClose}
      role="dialog"
      aria-modal="true"
      ...
      >
        <div className="mb-4 flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <h3 id="help-settings-title" className="text-lg font-semibold text-gray-900 dark:text-white">
              Hilfe-Einstellungen
            </h3>
          </div>
          <button
            type="button"
            onClick={onClose}
            className="text-gray-400 transition hover:text-gray-600 focus:outline-none focus:ring-2 focus:ring-vae-turquoise/50 dark:text-white/60 dark:hover:text-white"
        ...
        <div className="space-y-3">
          <label className="group flex cursor-pointer items-start gap-3">
            <input
              ...
              className="mt-0.5 h-4 w-4 rounded border-gray-300 bg-white text-vae-turquoise focus:ring-2 focus:ring-vae-turquoise/50 dark:border-gray-600 dark:bg-gray-700 dark:checked:bg-vae-turquoise"
            />
            <div className="flex-1">
              <p className="text-sm font-medium text-gray-900 group-hover:text-gray-800 dark:text-white dark:group-hover:text-gray-100">
