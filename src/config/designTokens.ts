...
export const DESIGN_TOKENS = {
  ...
  GRADIENT: {
    ...
    SURFACE_3: 'radial-gradient(circle at 25% 30%, hsla(var(--color-vae-turquoise), 0.10), transparent 65%), linear-gradient(160deg, hsl(var(--color-bg-darker)) 0%, hsl(var(--color-bg-dark)) 100%)',
    SURFACE_4: 'linear-gradient(120deg, hsl(var(--color-bg-darker)) 0%, hsl(var(--color-bg-darker)) 40%, hsl(var(--color-bg-secondary)) 100%)',
    SURFACE_5: 'radial-gradient(circle at 70% 60%, hsla(var(--color-vae-turquoise), 0.10), transparent 70%), linear-gradient(145deg, hsl(var(--color-bg-dark)) 0%, hsl(var(--color-bg-secondary)) 100%)',
    BUTTON_PRIMARY: 'linear-gradient(135deg, hsl(var(--color-vae-turquoise) / 0.96), hsl(var(--color-vae-turquoise) / 0.88))'
  } as const
} as const
