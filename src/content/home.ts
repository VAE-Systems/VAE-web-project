export const heroTitle = ['Lokale KI-Infrastruktur', 'für deutsche Unternehmen.'] as const
...
export const homeOutcomesHeading = 'Messbarer Nutzen. Erweiterbare Architektur. Kontrollierte KI.'
...
export const homeProcessHeading = 'Von erster Einordnung zu belastbarem Betrieb'
