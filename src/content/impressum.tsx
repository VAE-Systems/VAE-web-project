  ...
  sections: [
    {
      ...
      body: (
        <>VAE Systems UG (haftungsbeschränkt)<br/>Brahmsstraße 4<br/>69214 Eppelheim<br/>Deutschland</>
      ),
    ...
    },
    {
      ...
      body: (
        <>Julian Darius Dini<br/>Jakob Dünnebeil</>
      )
    },
    {
      id: 'contact',
      title: 'Kontakt',
      body: (
        <>E-Mail: <a href="mailto:juliandini@vae-systems.com" className="text-vae-turquoise hover:underline">juliandini@vae-systems.com</a><br/>Telefon: +49 151 73024549</>
      )
    },
    {
      id: 'register',
      ...
      body: (
        <>Eingetragen im Handelsregister.<br/>Registergericht: Amtsgericht Mannheim<br/>Registernummer: HRB 754790</>
      )
    },
    {
      id: 'vat',
      ...
      body: (
        <>Umsatzsteuer-Identifikationsnummer gem. §27 a UStG: nicht vergeben</>
      )
    },
    {
