    ...
    tabs: [
      {
        ...
        solution: 'VAE Core ist unsere eigene, professionelle Plattform‑Architektur. Sie ermöglicht uns, Projekte schneller, robuster und langfristig günstiger zu liefern – und bleibt erweiterbar.',
        benefits: [
      ...
      },
      {
        ...
        solution: 'VAE Core ist quelloffen, dokumentiert und lokal startbar (Docker). Ideal zum Lernen und Forschen – mit echter Architektur‑Qualität.',
        benefits: [
  ...
  views: {
    interested: {
      meta: {
        ...
        description: 'Unsere professionelle Plattform‑Architektur ermöglicht effizientere, robustere KI‑Projekte. Transparenz, Qualität und Skalierbarkeit inklusive.'
      },
      hero: {
        titlePre: 'VAE Core',
        ...
        subline: 'Wir bauen auf einer eigenen, modularen Plattform – das spart Kosten, reduziert Risiken und bleibt erweiterbar.',
      ...
      problem: {
        ...
        pain_points: [
          { icon: 'Settings', title: 'Kein Fundament', desc: 'Individuelle Hacks statt wiederverwendbarer Architektur.' },
          { icon: 'TrendingUp', title: 'Kosten laufen aus dem Ruder', desc: 'Fehlende Standards führen zu Nacharbeiten und Wartungsstau.' },
          { icon: 'Shield', title: 'Sicherheitsfragen ungeklärt', desc: 'Daten, Compliance, Nachvollziehbarkeit – oft erst im Nachhinein bedacht.' },
      ...
      value_props: {
        ...
        pillars: [
          { icon: 'Layers', title: 'Architektur statt Ad‑hoc', body: 'Module, Schnittstellen und Standards – weniger Risiko, mehr Planbarkeit.', detail: 'Projektfortschritt bleibt nachvollziehbar und erweiterbar.' },
          { icon: 'RefreshCw', title: 'Flexibilität & Unabhängigkeit', body: 'Provider‑agnostischer Ansatz. Keine Sackgassen.', detail: 'Wechsel ohne Neuentwicklung.' },
          { icon: 'ShieldCheck', title: 'Transparenz & Governance', body: 'Open Source‑Kern, Audits & Observability.', detail: 'Compliance ist integrierbar statt drangeklatscht.' },
          { icon: 'Lock', title: 'Daten‑Souveränität', body: 'Self‑Hosting möglich, EU‑konform umsetzbar.', detail: 'Volle Kontrolle über sensible Daten.' }
        ]
      },
      pricing: {
        ...
        tiers: [
          { name: 'Open Source', price: '€0', period: '', description: 'Ideal zum Kennenlernen & Testen', features: ['Kompletter VAE Core', 'Docker‑Setup lokal', 'Community Support', 'Dokumentation'], cta: 'GitHub Repository', popular: false },
          { name: 'Beratung Starter', price: 'ab €990', period: '', description: 'Analyse, Empfehlung, Roadmap', features: ['2 Workshops', 'Ist‑Analyse & Zielbild', 'Security & Compliance Check', 'Konkreter Umsetzungsplan'], cta: 'Kostenloses Vorgespräch', popular: true },
          { name: 'Implementierungspaket', price: 'ab €4.900', period: '', description: 'Pilot bis produktionsreif', features: ['Produktionsreifer POC', 'Monitoring & Kostenkontrolle', 'Dokumentation & Übergabe', 'Option: Managed Betrieb'], cta: 'Projekt starten', popular: false }
        ],
        guarantee: 'Transparente Angebote. Kein Lock‑in. Messbare Ergebnisse.'
      },
      tech_deep_dive: {
        headline: 'Das Fundament hinter unseren Projekten',
        intro: 'Wir kombinieren Open‑Source‑Bausteine mit unserer Plattformlogik – bewährt, dokumentiert und erweiterbar.',
      ...
      comparison_brief: {
        ...
        comparisons: [
          { alternative: 'Ad‑hoc Entwicklung', vae_advantage: 'Architektur‑Standards & Templates', time_saved: 'Wochen/Monate sparen' },
          { alternative: 'Proprietäre Black‑Box', vae_advantage: 'Open‑Source‑Kern & Transparenz', time_saved: 'Lock‑in vermeiden' },
          { alternative: 'Ein‑Provider‑Abhängigkeit', vae_advantage: 'Provider‑Agnostik', time_saved: 'Strategiefreiheit' }
        ]
      },
      roadmap: {
        ...
        phases: [
          { quarter: 'Q4 2025', title: 'Foundation', status: 'In Entwicklung', items: ['Core Infrastructure', 'Security & RLS', 'Gateway‑Basis'] },
          { quarter: 'Q1 2026', title: 'Integration', status: 'Geplant', items: ['MCP Workflow', 'Provider Abstraction', 'Observability Basics'] },
          { quarter: 'Q2 2026', title: 'Public Preview', status: 'Ziel', items: ['Beta Launch', 'Docs', 'Design‑Partner Feedback'] }
        ],
    ...
    builders: {
      meta: {
        ...
        description: 'Produktionsreif entwickeln ohne Backend‑Neubau: RLS, Token‑Accounting, Audit‑Trails, LLM‑Gateway. Ab €149/Monat (Managed).'
      },
      hero: {
      ...
      problem: {
        ...
        pain_points: [
          { icon: 'Settings', title: 'Mandanten‑Komplexität', desc: 'Schlüssel, Limits, Isolation – alles pro Tenant.' },
      ...
      value_props: {
        ...
        pillars: [
          { icon: 'Layers', title: 'Integrierte Architektur', body: 'Gateway, State, Security & Tools greifen ineinander.', detail: 'Komplett statt Stückwerk.' },
          { icon: 'Lock', title: 'Echte Isolation', body: 'RLS & Policies auf DB‑Ebene.', detail: 'Sicher auditierbar.' },
          { icon: 'RefreshCw', title: 'LLM‑Flexibilität', body: 'OpenAI heute, Claude morgen – 1 API Call.', detail: 'Preise verhandeln ohne Rewrites.' },
          { icon: 'ShieldCheck', title: 'Souveränität', body: 'Open Source + Self‑Hosting möglich.', detail: 'Volle Transparenz.' }
        ]
      },
      pricing: {
        ...
        tiers: [
          { name: 'Open Source', price: '€0', period: 'für immer', description: 'Perfekt für Entwicklung & Testing', features: ['Kompletter VAE Core Stack', 'Self‑Hosting (Docker)', 'Community Support', 'Alle Core‑Features', 'Unbegrenzte Projekte'], cta: 'GitHub Repository', popular: false },
          { name: 'Managed Pro', price: '€149', period: '/Monat', description: 'Konzentrieren Sie sich aufs Produkt', features: ['EU‑Hosting', '5M Tokens inkl.', '3 Team‑Seats', 'Email Support', 'SLA 99.5%', '+ €0.50 / 100k extra Tokens'], cta: 'Pro Plan starten', popular: true },
          { name: 'Enterprise', price: 'ab €1.500', period: '/Monat', description: 'Hohe Sicherheits‑/Compliance‑Anforderungen', features: ['Dedicated Cloud/On‑Prem', 'Unbegrenzte Tokens & User', 'SSO & Advanced RBAC', 'Priority Support & SLA', 'Custom Compliance'], cta: 'Gespräch vereinbaren', popular: false }
        ],
      ...
      comparison_brief: {
        ...
        comparisons: [
          { alternative: 'LangChain + Custom Backend', vae_advantage: 'Komplette Infrastruktur statt nur Bibliothek', time_saved: '6–12 Monate' },
          { alternative: 'Assistants API', vae_advantage: 'Provider‑Unabhängigkeit + EU‑Hosting', time_saved: 'Lock‑in vermieden' },
          { alternative: 'Portkey/LiteLLM', vae_advantage: 'Gateway + State + Multi‑Tenancy integriert', time_saved: '3–6 Monate' }
        ]
      },
      roadmap: {
        headline: 'Roadmap bis Launch (Q2 2026)',
        ...
        phases: [
          { quarter: 'Q4 2025', title: 'Foundation', status: 'In Entwicklung', items: ['Core Infrastructure', 'Multi‑Tenant Security', 'Gateway'] },
          { quarter: 'Q1 2026', title: 'Integration', status: 'Geplant', items: ['MCP Workflow', 'Provider Abstraction', 'Observability'] },
          { quarter: 'Q2 2026', title: 'Public Preview', status: 'Ziel', items: ['Beta Launch', 'Documentation', 'Design Partner Feedback'] }
        ],
    ...
    agencies: {
      ...
      problem: {
        ...
        pain_points: [
          ...
          { icon: 'Shield', title: 'Qualitätssicherung', desc: 'Fehlende Standards erschweren verlässliche Ergebnisse.' },
      ...
      value_props: {
        ...
        pillars: [
          { icon: 'Layers', title: 'Standardisierte Architektur', body: 'Wiederverwendbare Module und Templates.', detail: 'Konsistente Qualität, weniger Risiko.' },
          { icon: 'RefreshCw', title: 'Provider‑Agnostik', body: 'Alle gängigen LLMs ohne Custom‑Ballast.', detail: 'Strategische Freiheit.' },
          { icon: 'Lock', title: 'Wartbarkeit', body: 'Dokumentierte Patterns & Governance.', detail: 'Weniger Nacharbeiten.' },
          { icon: 'ShieldCheck', title: 'Sichere Tool‑Execution', body: 'MCP mit klaren Grenzen.', detail: 'Für sensible Prozesse.' }
        ]
      },
      pricing: {
        ...
        tiers: [
          { name: 'Open Source', price: '€0', period: '', description: 'Für Evaluation & erste Projekte', features: ['VAE Core', 'Docker‑Setup', 'Community Support', 'Dokumentation'], cta: 'GitHub Repository', popular: false },
          { name: 'Managed Pro', price: '€149', period: '/Monat', description: 'Konzentriert auf Delivery', features: ['EU‑Hosting', '5M Tokens inkl.', '3 Team‑Seats', 'SLA 99.5%'], cta: 'Pro Plan starten', popular: false },
          { name: 'Agentur‑Partner', price: 'auf Anfrage', period: '', description: 'Co‑Delivery & Go‑To‑Market', features: ['Lead‑Sharing & Co‑Marketing', 'Enablement & Templates', 'Priorisierter Support', 'Playbooks & Best Practices'], cta: 'Partner‑Programm anfragen', popular: true }
        ],
      ...
      comparison_brief: {
        ...
        comparisons: [
          { alternative: 'Individuelle Infrastruktur', vae_advantage: 'Standardisierte Plattform', time_saved: 'Monate sparen' },
          { alternative: 'Ein‑Provider‑Stack', vae_advantage: 'Agnostisch & erweiterbar', time_saved: 'Lock‑in vermeiden' },
          { alternative: 'Ad‑hoc Monitoring', vae_advantage: 'Observability integriert', time_saved: 'Troubleshooting schneller' }
        ]
      },
      roadmap: {
        headline: 'Roadmap bis Launch (Q2 2026)',
        ...
        phases: [
          { quarter: 'Q4 2025', title: 'Foundation', status: 'In Entwicklung', items: ['Core & Policies', 'Gateway', 'Templates'] },
          { quarter: 'Q1 2026', title: 'Partner Enablement', status: 'Geplant', items: ['Playbooks', 'Module', 'Best Practices'] },
    ...
    oss: {
      meta: {
        ...
        description: 'Kostenfrei für nicht‑kommerzielle Nutzung: Schulen, Hochschulen, private Projekte. Transparent, dokumentiert, lokal startbar.'
      },
      hero: {
        titlePre: 'VAE Core',
      ...
      value_props: {
        ...
        pillars: [
          { icon: 'Layers', title: 'Echte Architektur', body: 'Lernen an produktionsreifen Bausteinen.', detail: 'Nicht nur Spielzeug.' },
          { icon: 'ShieldCheck', title: 'Transparenz', body: 'Open‑Source‑Kern, verständliche Docs.', detail: 'Volle Nachvollziehbarkeit.' },
          { icon: 'RefreshCw', title: 'Upgrade‑Pfad', body: 'Von lokal zu Managed/Enterprise.', detail: 'Wenn es ernst wird.' },
          { icon: 'Lock', title: 'Souveränität', body: 'Lokal betreibbar – volle Datenkontrolle.', detail: 'Perfekt für Bildung.' }
        ]
      },
      pricing: {
        ...
        tiers: [
          { name: 'Open Source', price: '€0', period: '', description: 'Schulen, Hochschulen, private Projekte', features: ['Quelloffen', 'Docker‑Compose Setup', 'Community Support', 'Beitragen willkommen'], cta: 'Zu GitHub', popular: true },
          { name: 'Community Sponsor', price: '€9', period: '/Monat', description: 'Unterstützen Sie das Projekt', features: ['Badge im Repo', 'Priorisierte Issue‑Antworten', 'Einladung zur Community‑Call'], cta: 'Sponsor werden', popular: false }
        ],
      ...
      comparison_brief: {
        ...
        comparisons: [
          { alternative: 'Nur‑Demo‑Frameworks', vae_advantage: 'Produktionsreife Architektur', time_saved: 'Realitätsnah' },
          { alternative: 'Geschlossene Systeme', vae_advantage: 'Open‑Source‑Transparenz', time_saved: 'Wissen wächst' },
      ...
      roadmap: {
        ...
        phases: [
          { quarter: 'Q4 2025', title: 'OS‑Foundation', status: 'In Entwicklung', items: ['Docker Setup', 'Docs Basics', 'Issue‑Templates'] },
          { quarter: 'Q1 2026', title: 'Module & Examples', status: 'Geplant', items: ['Beispiel‑Projekte', 'Didaktische Guides', 'Community‑Calls'] },
          { quarter: 'Q2 2026', title: 'Public Preview', status: 'Ziel', items: ['Stabile Releases', 'Contrib‑Guides', 'Showcase‑Wettbewerb'] }
        ],
