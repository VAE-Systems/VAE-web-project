 ...
 */
export const generateClamp = (minSize: number, maxSize: number, mobileSize: number, scaleFactor: number): string => {
 ...
 */
export const generateSpacingClamp = (baseValue: number, scaleFactor: number): string => {
 ...
 */
export const calculateTypographyScale = (baseSize: number, scaleRatio: number, steps: number): ScaleValue[] => {
