  ...
  return (
    <div className="min-h-screen bg-dark p-8">
      <div className="max-w-6xl mx-auto">
        <h1 className="text-4xl font-bold text-vae-turquoise mb-8">
          🎨 Design System Demo
        </h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div className="bg-secondary p-6 rounded-lg">
            <h2 className="text-2xl font-semibold text-vae-turquoise mb-4">
              Typografie-Skala
            </h2>
          ...
          <div className="bg-secondary p-6 rounded-lg">
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-2">
                <div className="w-4 h-4 bg-vae-turquoise rounded"></div>
                <span className="text-sm">xs: 0.25rem</span>
              </div>
              <div className="flex items-center gap-2">
                <div className="w-6 h-6 bg-vae-turquoise rounded"></div>
                <span className="text-sm">sm: 0.5rem</span>
              </div>
              <div className="flex items-center gap-2">
                <div className="w-8 h-8 bg-vae-turquoise rounded"></div>
                <span className="text-sm">base: 1rem</span>
              </div>
              <div className="flex items-center gap-2">
                <div className="w-12 h-12 bg-vae-turquoise rounded"></div>
                <span className="text-sm">lg: 1.5rem</span>
              </div>
              <div className="flex items-center gap-2">
                <div className="w-16 h-16 bg-vae-turquoise rounded"></div>
                <span className="text-sm">xl: 2rem</span>
              </div>
              <div className="flex items-center gap-2">
                <div className="w-20 h-20 bg-vae-turquoise rounded"></div>
                <span className="text-sm">2xl: 3rem</span>
              </div>
              <div className="flex items-center gap-2">
                <div className="w-24 h-24 bg-vae-turquoise rounded"></div>
            ...
            <div className="space-y-4">
              <div className="bg-dark p-4 rounded">
                ...
                <p className="text-xs md:text-sm lg:text-base">
                  Dieser Text skaliert automatisch mit dem Viewport
                </p>
              </div>
              <div className="bg-dark p-4 rounded">
                <p className="ds-text-base mb-2">Proportionale Skalierung:</p>
                <p className="text-sm">
                  Alle Elemente skalieren zusammen - kein Design-Break!
                </p>
              </div>
              <div className="bg-dark p-4 rounded">
        ...
        <div className="mt-12 bg-secondary p-6 rounded-lg">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              <h3 className="text-lg font-medium text-white mb-2">1. Zentrales Design-System</h3>
              <p className="text-gray-300 text-sm">
                Alle Größen werden aus einem einzigen Scale-Factor berechnet.
                Änderungen wirken sich proportional auf das gesamte System aus.
              </p>
            </div>
            <div>
              <h3 className="text-lg font-medium text-white mb-2">2. Responsive clamp()-Funktionen</h3>
              <p className="text-gray-300 text-sm">
                Automatische Anpassung zwischen Minimum, fluidem Bereich und Maximum.
                Keine Media-Queries nötig!
              </p>
            </div>
            <div>
              <h3 className="text-lg font-medium text-white mb-2">3. CSS-Variablen</h3>
              <p className="text-gray-300 text-sm">
                Alle Werte werden als CSS-Variablen gespeichert und können
                zur Laufzeit aktualisiert werden.
              </p>
            </div>
            <div>
              <h3 className="text-lg font-medium text-white mb-2">4. Konsistente Skalierung</h3>
              <p className="text-gray-300 text-sm">
                Spacing, Typografie und alle anderen Elemente skalieren zusammen.
                Das Design bleibt immer harmonisch.
              </p>
            </div>
          </div>
        </div>
